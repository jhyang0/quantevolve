"""
Program database for QuantEvolve
"""
...
from quantevolve.config import DatabaseConfig
from quantevolve.utils.code_utils import calculate_edit_distance
        ...
        for dim in self.config.feature_dimensions:
            if dim == "complexity":
                ...
                if isinstance(score, (int, float)) and not isinstance(score, bool):
                    ...
                    # Default to middle bin for non-numeric values
                    bin_idx = self.feature_bins // 2
                coords.append(bin_idx)
            else:
