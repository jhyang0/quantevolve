...
# Set dummy API key for testing to prevent Google API SDK import failures
os.environ["GOOGLE_API_KEY"] = "test"

from quantevolve.config import Config
from quantevolve.controller import QuantEvolveController
...
"""
    ...
    def test_fresh_start_adds_initial_program(self):
        ...
        async def run_test():
            with patch("quantevolve.controller.Evaluator") as mock_evaluator_class:
